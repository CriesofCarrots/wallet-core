...
describe('SolanaSigner', () => {
    it('test Solana transfer transaction signing', () => {
        const transferMessage = TW.Solana.Proto.Transfer.create({
            amount: Long.fromString("42"),
    ...
    it('test Solana delegateStake transaction signing', () => {
        const stakeMessage = TW.Solana.Proto.Stake.create({
            amount: Long.fromString("42"),
            fromPrivateKey: Base58.decodeNoCheck('GGT4G41n1K3E4MTjb7VwADSFNJA3Jx7wUxm54Fpcje6w'),
            stakePrivateKey: Base58.decodeNoCheck('2bwUDLUVYCfUhQHiAiwvHzM8oNT7pdk5J1XjhTLeumP5'),
            votePubkey: "FkL2bzbUbp3J9MQEX3toMBA4q8ZcHcjeacdtn2Ti8Qec",
        });
        const signingInput = TW.Solana.Proto.SigningInput.create({
            recentBlockhash: "11111111111111111111111111111111",
            stakeTransaction: stakeMessage,
        });
    ...
    it('test Solana deactivateStake transaction signing', () => {
        const deactivateStakeMessage = TW.Solana.Proto.DeactivateStake.create({
            stakePrivateKey: Base58.decodeNoCheck('5PcaDJjTMnZEqJzayijWhYJAbUuURjtkJq8Zi2HD2k7Q'),
    ...
    it('test Solana withdrawStake transaction signing', () => {
        const withdrawMessage = TW.Solana.Proto.WithdrawStake.create({
            amount: Long.fromString("42"),
        ...
        const signingInput = TW.Solana.Proto.SigningInput.create({
            recentBlockhash: "11111111111111111111111111111111",
            withdrawTransaction: withdrawMessage,
        });
